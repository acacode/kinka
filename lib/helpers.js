...
function createRequest(method, path, requestOptions, requestData) {
  ...
  // property body is deprecated
  // and if body is exist then value will assign to data property
  if (options.body) {
    console.warn(
  ...
  // if abortable key is exist then reference of instance will attach to abortableRequests
