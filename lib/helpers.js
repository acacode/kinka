...
function createRequest(method, path, requestOptions, requestData) {
  ...
  typeCheck(requestOptions, 'object', 'requestOptions', false, true)
  ...
  typeCheck(onDownloadProgress, 'function', 'onDownloadProgress', false, true)
  typeCheck(onUploadProgress, 'function', 'onUploadProgress', false, true)
  ...
  return new Promise(function(resolve, reject) {
    ...
    request.onreadystatechange = function() {
      if (request.readyState === 4) {
        typeCheck(options.successStatus, 'number', 'successStatus', false, true)
