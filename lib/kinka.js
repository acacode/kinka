...
function createInstance(config) {
  ...
  this.baseURL = config.baseURL || (location && location.origin) || ''
  ...
  this.inspectors = config.inspectors || {}
  ...
  typeCheck(this.config.timeout, 'number', 'timeout in your kinka instance')
  typeCheck(this.config.charset, 'string', 'charset in your kinka instance')
  if (config.auth) {
