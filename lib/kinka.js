...
if (!ArrayBuffer.isView) {
  ArrayBuffer.isView = function (data) {
    return data !== null && typeof data === 'object' && data.buffer instanceof ArrayBuffer;
  };
}
/*
...
function createRequest(method, path, requestOptions, requestData) {
  ...
  var onUploadProgress = options.onUploadProgress; // create XMLHttpRequest instance
...
var helpers = process.env.NODE_ENV === 'production' ? {
 ...
 * @flow
 */
var isUndefined$1 = undefined,
    abortRequest$1 = undefined,
    createRequest$1 = undefined;
...
function Kinka(instanceOptions) {
  ...
  this.instanceOptions = {
    omitCatches: isUndefined$1(instanceOptions.omitCatches, true),
    headers: isUndefined$1(instanceOptions.headers, {}),
    timeout: isUndefined$1(instanceOptions.timeout, 0),
    charset: isUndefined$1(instanceOptions.charset, 'utf-8')
  };
