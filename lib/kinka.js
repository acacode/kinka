 ...
 *
 * @class
 * @param {object?} instanceOptions Configuration of your api (See documentation: https://github.com/acacode/kinka/blob/master/docs/documentation.md)
 * @param {string?} instanceOptions.baseURL Sets the base url address for api.
 * @param {string[]?} instanceOptions.customMethods Sets the custom methods for api.
 * @param {boolean?} instanceOptions.omitCatches Enable/Disable catching your request (See documentation)
 * @param {object?} instanceOptions.headers Sets the request headers for each request created via api.
 * @param {number?} instanceOptions.timeout Sets the timeout for each request
 * @param {string?} instanceOptions.charset Sets the charset
 * @param {object?} instanceOptions.inspectors Sets the inspectors (See documentation)
 * @param {function?} instanceOptions.auth Attach the auth mixin (See documentation)
 */
