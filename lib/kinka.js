...
if (process.env.NODE_ENV !== 'production') {
  ...
  globalObject.typeCheck = function(
    ...
    function validateType() {
      switch (type) {
        case 'array': {
          var isValid = type instanceof Array
          return isValid
        }
        default: {
    ...
    // TODO: add specific type checks for object like -> value !== null && (value instanceOf Array) && typeof value === type
  }
...
function Kinka(instanceOptions) {
  ...
  if (customMethods) {
    typeCheck(
      customMethods,
      'array',
      'custom methods with name in your kinka instance'
    )
  ...
  typeCheck(this.inspectors, 'object', 'inspectors for your kinka instance')
