...
<table>
  ...
  <tr>
	...
	kinka.get('/users', { cancelKey: 'usersKey' })
...
const test = async () => {
  ...
  // first and second requests has been catched because for each one specified same param 'cancelKey'
